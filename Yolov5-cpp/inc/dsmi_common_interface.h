...
typedef enum {
    DSMI_LP_SUB_CMD_AICORE_VOLTAGE_CURRENT = 0, // Obtain the AICORE voltage and current value from the low-power module.
    DSMI_LP_SUB_CMD_HYBIRD_VOLTAGE_CURRENT,     // Obtain the HYBIRD voltage and current value from the low-power module.
    DSMI_LP_SUB_CMD_TAISHAN_VOLTAGE_CURRENT,    // Obtain the TAISHAN voltage and current value from the low-power module.
    DSMI_LP_SUB_CMD_DDR_VOLTAGE_CURRENT,        // Obtain the DDR voltage and current value from the low-power module.
    DSMI_LP_SUB_CMD_MAX,
} DSMI_LP_SUB_CMD;
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend910,Ascend710
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend710
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend910,Ascend610,Ascend710,Ascend310
*/
 ...
 * @return  0 for success, others for fail
 * @note Support:Ascend610,Ascend910
 */
...
* @param [in] info:vdev_num       number of vdavinci device to be created
* @param [in] info:spec_info      spec. info for each vdavinci device
* @param [out] info:vdevid        id number of each vdavinci device alloced
* @return  0 for success, others for fail
* @note Support:Ascend910
*/
DLLEXPORT int dsmi_create_vdevice(unsigned int devid, struct dsmi_vdev_create_info *info);
...
/**
* @ingroup driver
* @brief query vdevice info created by device(devid)
* @attention used on host side
* @param [in] devid       the logic id of device that create vdavinci device
* @param [out] info       spec. info of vdevice
* @return  0 for success, others for fail
* @note Support:Ascend910
*/
DLLEXPORT int dsmi_get_vdevice_info(unsigned int devid, struct dsmi_vdev_info *info);
...
* @return  0 for success, others for fail
* @note Support:Ascend910,Ascend710,Ascend310
*/
